...
int main(int argc, char **argv) {
  ...
  for (;;) {
    ...
    switch (c) {
      ...
      case 'h':usage(stdout, argc, argv);
        exit(EXIT_SUCCESS);

      case 'm':io = IO_METHOD_MMAP;
        break;

      case 'r':io = IO_METHOD_READ;
        break;

      case 'u':io = IO_METHOD_USERPTR;
        break;
      ...
      default:usage(stderr, argc, argv);
        exit(EXIT_FAILURE);
    }
  }
